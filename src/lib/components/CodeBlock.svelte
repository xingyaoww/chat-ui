...
<div class="group relative my-4 rounded-lg">
	...
	{#if lang === "result"}
		<div class="rounded-lg bg-gray-800 p-4 text-xs">
			...
			class="scrollbar-custom scrollbar-thumb-gray-500 hover:scrollbar-thumb-gray-400 dark:scrollbar-thumb-white/10 dark:hover:scrollbar-thumb-white/20 overflow-auto px-5 max-h-[60vh]"
			style="padding-left: 0; padding-right: 0; padding-bottom: 0; padding-top: 0; font-size: 0.75rem;"
			><code
